          ...
          <c:if test="${sessionScope.isSiteAdmin}">
	          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Administration <b class="caret"></b></a>
	            <ul class="dropdown-menu">
                  ...
                  <li class="dropdown-submenu"><a href="#">Manage DT4 Information</a>
	                <ul class="dropdown-menu">
	                  <li><a id="programCodesMasterList" href="javascript:void(0)" onclick="submitXsrfForm('${pageContext.request.contextPath}/siteadmin/programCodesexecute.action');">Manage Program Code Master List</a></li>
	                  <li><a id="programCodesAssignmentAndCenterTargetAccrual" href="javascript:void(0)" onclick="submitXsrfForm('${pageContext.request.contextPath}/siteadmin/managePCAssignmentexecute.action');">Manage Program Code Assignment & Targeted Accrual for Your Center</a></li>
	                </ul>
	              </li>
                  </c:if>
