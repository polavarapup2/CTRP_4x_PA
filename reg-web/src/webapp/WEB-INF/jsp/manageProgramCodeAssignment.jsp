...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/styles/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" media="all" />
        ...
        <script type="text/javascript" language="javascript" src="<c:url value='/scripts/js/bootstrap-editable.js'/>"></script>
                            ...
                            <div id="row_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <table id="trialsTbl" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>Trial Status</th>
                                        <th>Targeted Accrual for Your Center</th>
                                        <th>
                                            Program Code(s)
