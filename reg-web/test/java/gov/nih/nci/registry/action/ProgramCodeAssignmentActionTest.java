...
public class ProgramCodeAssignmentActionTest  extends AbstractRegWebTest {
    ...
    public void init() throws Exception {
        ...
        studyCancerCenterAccrualService = mock(StudyCancerCenterAccrualServiceRemote.class);
        ...
        action.setStudyCancerCenterAccrualService(studyCancerCenterAccrualService);
        ...
        when(studyCancerCenterAccrualService.getStudyCancerCenterAccrualsByFamily(any(Long.class))).thenReturn(new HashMap<Long, Integer>());
    ...
    @Test
    public void testUpdateTargetAccrualWithoutRequiredParams() {
      try {
          ...
          StreamResult sr = action.updateTargetAccrual();
          
          //then I must see no fields
          InputStream is = (InputStream) field.get(sr);
          String json = IOUtils.toString(is);
          assertEquals("{\"data\":[],\"msg\":\"Required parameters missing\",\"success\":false}", json);    
      } catch (Exception e) {
          e.printStackTrace();
    ...
    @Test
    public void testUpdateTargetAccrual() {
      try {
    ...
    public void testFindTrials() {
      try {
          ...
          is = (InputStream) field.get(sr);
          json = IOUtils.toString(is);
          assertEquals("{\"endDateChanged\":false,\"updated\":false,\"lengthChanged\":false,\"data\":[{\"title\":\"title\",\"identifiers\":\"1, 2\",\"programCodes\":[{\"id\":3,\"name\":\"3\",\"code\":\"3\"},{\"id\":4,\"name\":\"4\",\"code\":\"4\"}],\"DT_RowId\":\"trial_null\",\"trialStatus\":\"Active\",\"piFullName\":\"Joel Joseph\",\"nciIdentifier\":\"1\",\"targetAccrual\":\"\"}]}", json);
