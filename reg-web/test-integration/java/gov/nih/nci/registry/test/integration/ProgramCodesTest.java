...
public class ProgramCodesTest extends AbstractRegistrySeleniumTest {
    ...
    public void testProgramCodesMenu() throws Exception {    	
        ...
        assertTrue(selenium.isTextPresent("Manage DT4 Information"));        
        hoverLink("Manage DT4 Information");
        assertTrue(selenium.isTextPresent("Manage Program Code Master List"));
        assertTrue(selenium.isTextPresent("Manage Program Code Assignment & Targeted Accrual for Your Center"));
    }    
    ...
    public void testProgramCodesMenuNotVisibleForNonFamily() throws Exception {    	   	
        ...
        hoverLink("Administration");        
        assertFalse(selenium.isTextPresent("Manage DT4 Information"));       
    }
    ...
    private void accessManageMasterListScreen() {    	
        ...
        hoverLink("Manage DT4 Information");
        clickAndWait("link=Manage Program Code Master List");
