CREATE TABLE secondary_purpose
(
...
INSERT INTO secondary_purpose (name) VALUES ('Ancillary');
INSERT INTO secondary_purpose (name) VALUES ('Correlative');

alter table study_protocol add column secondary_purpose_id int8;

ALTER TABLE study_protocol ADD CONSTRAINT study_protocol_secondary_purpose_id FOREIGN KEY (secondary_purpose_id) 
    REFERENCES secondary_purpose (identifier) ON DELETE SET NULL;
 
alter table study_protocol add column STUDY_SUBTYPE_CODE varchar(64);

alter table study_protocol_stage add column secondary_purpose_id int8;
alter table study_protocol_stage add column STUDY_SUBTYPE_CODE varchar(64);
alter table study_protocol_stage add column STUDY_MODEL_CODE varchar(64);
alter table study_protocol_stage add column STUDY_MODEL_OTHER_TEXT varchar(200);
alter table study_protocol_stage add column time_perspective_code varchar(64);
alter table study_protocol_stage add column time_perspective_other_text varchar(200);
