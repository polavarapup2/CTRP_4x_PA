alter table study_protocol add column pcd_sent_to_pio_date timestamp without time zone;
alter table study_protocol add column pcd_confirm_date timestamp without time zone;
alter table study_protocol add column designee_notified_date timestamp without time zone;
alter table study_protocol add column reporting_in_process_date timestamp without time zone;
alter table study_protocol add column three_month_reminder_date timestamp without time zone;
alter table study_protocol add column five_month_reminder_date timestamp without time zone;
alter table study_protocol add column seven_month_escalation_to_pio_date timestamp without time zone;
alter table study_protocol add column results_sent_to_pio_date timestamp without time zone;
alter table study_protocol add column results_approved_by_pio_date timestamp without time zone;
alter table study_protocol add column prs_release_date timestamp without time zone;
alter table study_protocol add column qa_comments_return_date timestamp without time zone;
alter table study_protocol add column trial_published_date timestamp without time zone;
