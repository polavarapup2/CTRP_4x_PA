    ...
    extends BaseSearchResult
{
    ...
    public PersonSearchResult withCtepID(String value) {
        setCtepID(value);
        return this;
    }

    public PersonSearchResult withFirstName(String value) {
        setFirstName(value);
        return this;
    }

    public PersonSearchResult withMiddleName(String value) {
        setMiddleName(value);
        return this;
    }

    public PersonSearchResult withLastName(String value) {
        setLastName(value);
        return this;
    }

    public PersonSearchResult withTotalCrs(int value) {
        setTotalCrs(value);
        return this;
    }

    public PersonSearchResult withTotalHcp(int value) {
        setTotalHcp(value);
        return this;
    }

    public PersonSearchResult withTotalOc(int value) {
        setTotalOc(value);
        return this;
    }

    public PersonSearchResult withTotalPending(int value) {
        setTotalPending(value);
        return this;
    }

    public PersonSearchResult withAffiliation(Affiliation... values) {
        if (values!= null) {
            for (Affiliation value: values) {
                getAffiliation().add(value);
            }
        }
        return this;
    }

    public PersonSearchResult withAffiliation(Collection<Affiliation> values) {
        if (values!= null) {
            getAffiliation().addAll(values);
        }
        return this;
    }

    @Override
    public PersonSearchResult withId(long value) {
        setId(value);
        return this;
    }

    @Override
    public PersonSearchResult withStatusCode(EntityStatus value) {
        setStatusCode(value);
        return this;
    }

    @Override
    public PersonSearchResult withLine1(String value) {
        setLine1(value);
        return this;
    }

    @Override
    public PersonSearchResult withLine2(String value) {
        setLine2(value);
        return this;
    }

    @Override
    public PersonSearchResult withCity(String value) {
        setCity(value);
        return this;
    }

    @Override
    public PersonSearchResult withState(String value) {
        setState(value);
        return this;
    }

    @Override
    public PersonSearchResult withCountryCode(CountryISO31661Alpha3Code value) {
        setCountryCode(value);
        return this;
    }

    @Override
    public PersonSearchResult withCountryName(String value) {
        setCountryName(value);
        return this;
    }

    @Override
    public PersonSearchResult withPostalcode(String value) {
        setPostalcode(value);
        return this;
    }

    @Override
    public PersonSearchResult withEmailAddresses(String value) {
        setEmailAddresses(value);
        return this;
    }

    @Override
    public PersonSearchResult withPhones(String value) {
        setPhones(value);
        return this;
    }

    @Override
    public PersonSearchResult withDuplicateOf(Long value) {
