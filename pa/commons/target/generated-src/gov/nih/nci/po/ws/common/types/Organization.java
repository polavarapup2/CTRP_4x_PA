    ...
    extends EntityWithStatus
{
    ...
    public Organization withCtepId(String value) {
        setCtepId(value);
        return this;
    }

    public Organization withAddress(Address value) {
        setAddress(value);
        return this;
    }

    public Organization withContact(Contact... values) {
        if (values!= null) {
    ...
    public Organization withContact(Collection<Contact> values) {
        if (values!= null) {
    ...
    @Override
    public Organization withStatus(EntityStatus value) {
        setStatus(value);
        return this;
    }

    @Override
    public Organization withId(Long value) {
        setId(value);
        return this;
    }
