    ...
    extends Role
{
    ...
    public PersonRole withPersonId(long value) {
        setPersonId(value);
        return this;
    }

    @Override
    public PersonRole withOrganizationId(long value) {
        setOrganizationId(value);
        return this;
    }

    @Override
    public PersonRole withAddress(Address... values) {
        if (values!= null) {
    ...
    @Override
    public PersonRole withAddress(Collection<Address> values) {
        if (values!= null) {
    ...
    @Override
    public PersonRole withContact(Contact... values) {
        if (values!= null) {
    ...
    @Override
    public PersonRole withContact(Collection<Contact> values) {
        if (values!= null) {
    ...
    @Override
    public PersonRole withStatus(EntityStatus value) {
        setStatus(value);
        return this;
    }

    @Override
    public PersonRole withId(Long value) {
        setId(value);
        return this;
    }
