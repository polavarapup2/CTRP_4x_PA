...
public class PersonRoleList {
    ...
    public PersonRoleList withPersonRole(PersonRole... values) {
        if (values!= null) {
            for (PersonRole value: values) {
                getPersonRole().add(value);
            }
        }
        return this;
    }

    public PersonRoleList withPersonRole(Collection<PersonRole> values) {
        if (values!= null) {
            getPersonRole().addAll(values);
        }
        return this;
    }
