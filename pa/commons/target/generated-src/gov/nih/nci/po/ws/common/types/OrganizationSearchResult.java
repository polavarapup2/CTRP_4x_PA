    ...
    extends BaseSearchResult
{
    ...
    public OrganizationSearchResult withOrganizationName(String value) {
        setOrganizationName(value);
        return this;
    }

    public OrganizationSearchResult withFamilyName(String value) {
        setFamilyName(value);
        return this;
    }

    public OrganizationSearchResult withRoCtepID(String value) {
        setRoCtepID(value);
        return this;
    }

    public OrganizationSearchResult withHcfCtepID(String value) {
        setHcfCtepID(value);
        return this;
    }

    public OrganizationSearchResult withOrgCtepId(String value) {
        setOrgCtepId(value);
        return this;
    }

    public OrganizationSearchResult withChangeRequests(int value) {
        setChangeRequests(value);
        return this;
    }

    public OrganizationSearchResult withPendingROs(int value) {
        setPendingROs(value);
        return this;
    }

    public OrganizationSearchResult withPendingHCFs(int value) {
        setPendingHCFs(value);
        return this;
    }

    public OrganizationSearchResult withStatusDate(XMLGregorianCalendar value) {
        setStatusDate(value);
        return this;
    }

    public OrganizationSearchResult withTotalROs(int value) {
        setTotalROs(value);
        return this;
    }

    public OrganizationSearchResult withTotalHCFs(int value) {
        setTotalHCFs(value);
        return this;
    }

    public OrganizationSearchResult withTotalIdOrgs(int value) {
        setTotalIdOrgs(value);
        return this;
    }

    public OrganizationSearchResult withTotalOversightCommitees(int value) {
        setTotalOversightCommitees(value);
        return this;
    }

    public OrganizationSearchResult withTotalOrgContacts(int value) {
        setTotalOrgContacts(value);
        return this;
    }

    public OrganizationSearchResult withAlias(Alias... values) {
        if (values!= null) {
            for (Alias value: values) {
                getAlias().add(value);
            }
        }
        return this;
    ...
    public OrganizationSearchResult withAlias(Collection<Alias> values) {
        if (values!= null) {
    ...
    @Override
    public OrganizationSearchResult withId(long value) {
        setId(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withStatusCode(EntityStatus value) {
        setStatusCode(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withLine1(String value) {
        setLine1(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withLine2(String value) {
        setLine2(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withCity(String value) {
        setCity(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withState(String value) {
        setState(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withCountryCode(CountryISO31661Alpha3Code value) {
        setCountryCode(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withCountryName(String value) {
        setCountryName(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withPostalcode(String value) {
        setPostalcode(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withEmailAddresses(String value) {
        setEmailAddresses(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withPhones(String value) {
        setPhones(value);
        return this;
    }

    @Override
    public OrganizationSearchResult withDuplicateOf(Long value) {
