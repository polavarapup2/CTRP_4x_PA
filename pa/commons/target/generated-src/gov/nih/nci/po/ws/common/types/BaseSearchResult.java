...
public abstract class BaseSearchResult {
    ...
    public BaseSearchResult withId(long value) {
        setId(value);
        return this;
    }

    public BaseSearchResult withStatusCode(EntityStatus value) {
        setStatusCode(value);
        return this;
    }

    public BaseSearchResult withLine1(String value) {
        setLine1(value);
        return this;
    }

    public BaseSearchResult withLine2(String value) {
        setLine2(value);
        return this;
    }

    public BaseSearchResult withCity(String value) {
        setCity(value);
        return this;
    }

    public BaseSearchResult withState(String value) {
        setState(value);
        return this;
    }

    public BaseSearchResult withCountryCode(CountryISO31661Alpha3Code value) {
        setCountryCode(value);
        return this;
    }

    public BaseSearchResult withCountryName(String value) {
        setCountryName(value);
        return this;
    }

    public BaseSearchResult withPostalcode(String value) {
        setPostalcode(value);
        return this;
    }

    public BaseSearchResult withEmailAddresses(String value) {
        setEmailAddresses(value);
        return this;
    }

    public BaseSearchResult withPhones(String value) {
        setPhones(value);
        return this;
    }

    public BaseSearchResult withDuplicateOf(Long value) {
