    ...
    extends BaseSearchCriteria
{
    ...
    public OrganizationSearchCriteria withOrganizationName(String value) {
        setOrganizationName(value);
        return this;
    }

    public OrganizationSearchCriteria withFamilyName(String value) {
        setFamilyName(value);
        return this;
    }

    public OrganizationSearchCriteria withHasChangeRequest(Boolean value) {
        setHasChangeRequest(value);
        return this;
    }

    public OrganizationSearchCriteria withHasPendingHcfRoles(Boolean value) {
        setHasPendingHcfRoles(value);
        return this;
    }

    public OrganizationSearchCriteria withHasPendingRoRoles(Boolean value) {
        setHasPendingRoRoles(value);
        return this;
    }

    public OrganizationSearchCriteria withSearchAliases(Boolean value) {
        setSearchAliases(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withOffset(Integer value) {
        setOffset(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withLimit(Integer value) {
        setLimit(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withCtepID(String value) {
        setCtepID(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withId(Long value) {
        setId(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withStatusCode(EntityStatus value) {
        setStatusCode(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withLine1(String value) {
        setLine1(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withLine2(String value) {
        setLine2(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withCity(String value) {
        setCity(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withStateOrProvince(String value) {
        setStateOrProvince(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withCountryCode(CountryISO31661Alpha3Code value) {
        setCountryCode(value);
        return this;
    }

    @Override
    public OrganizationSearchCriteria withPostalcode(String value) {
        setPostalcode(value);
        return this;
    }
