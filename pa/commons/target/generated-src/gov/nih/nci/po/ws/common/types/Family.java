    ...
    extends EntityWithStatus
{
    ...
    public Family withStartDate(XMLGregorianCalendar value) {
        setStartDate(value);
        return this;
    }

    public Family withP30SerialNumber(String value) {
        setP30SerialNumber(value);
        return this;
    }

    public Family withMember(FamilyMember... values) {
        if (values!= null) {
            for (FamilyMember value: values) {
                getMember().add(value);
            }
        }
        return this;
    ...
    public Family withMember(Collection<FamilyMember> values) {
        if (values!= null) {
    ...
    @Override
    public Family withStatus(EntityStatus value) {
        setStatus(value);
        return this;
    }

    @Override
    public Family withId(Long value) {
        setId(value);
        return this;
    }
